                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <h3 align="center">Welcome <?php echo $_COOKIE["email"]; ?>!</h3><br>
                            <button type="button" class="btn btn-outline-primary btn-lg" style="width: 33%;" onclick="location.href='./edit-pan.php'">Edit PAN Details</button>
                            <button type="button" class="btn btn-outline-primary btn-lg" style="width: 33%;" onclick="location.href='./update-pass.php'">Update Password</button>
                            <button type="button" class="btn btn-outline-primary btn-lg" style="width: 33%;" onclick="location.href='./logout.php'">Logout</button>
                    </div>
