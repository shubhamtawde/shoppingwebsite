...
if(isset($_POST["submit"]))
{
    ...
    $ch2 = $_POST["checkbox2"];
    $ch3 = $_POST["checkbox3"];
    if(empty($ch1) && empty($ch2) && empty($ch3))
    {
        $modal="<i class='fa fa-exclamation-triangle' style='margin-right: 2%;'></i>Please select an attribute";
    }
    else
    {
        if(isset($_POST["checkbox1"]))
        {
            $upd="UPDATE posts_info SET p_name='$p_n1' WHERE id='p_id'";
        }
        $del = "DELETE FROM posts_info WHERE id='$id2'";
        $delete=$conn->query($del);
        if($delete)
        $modal="<i class='fa fa-trash' style='margin-right: 2%;'></i>Post Deleted Successfully!";
        else
        $modal="<i class='fa fa-trash' style='margin-right: 2%;'></i>Post Deleted Failed!";
    }
}
?>
?>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-edit"></i><a href="edit-posts.php">Edit Posts</a></li>
                        ...
                        <div>
                            ...
                            <form method="POST">
                                <div class="row form-group">
                                    <div class="col col-md-3"><div class="fa fa-tag" style="margin-right: 15px;"></div><label for="hf-product_id" class=" form-control-label">Product ID</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="product_id" placeholder="Enter your Product ID" class="form-control" name="p_id"></div>
                                </div>
                                <div class="row form-group">
                                        <div class="col col-md-3"><div class="fa fa-check-square-o" style="margin-right: 15px;"></div><label class=" form-control-label">Select the attributes to edit</label></div>
                                        <div class="col col-md-9">

                                            <div class="form-check">
                                                <div class="checkbox">
                                                    <label for="checkbox1" class="form-check-label ">
                                                        <input type="checkbox" id="checkbox1" name="checkbox1" value="Product Name" class="form-check-input">Product Name
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="checkbox2" class="form-check-label ">
                                                        <input type="checkbox" id="checkbox2" name="checkbox2" value="Product Price" class="form-check-input"> Product Price
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="checkbox3" class="form-check-label ">
                                                        <input type="checkbox" id="checkbox3" name="checkbox3" value="Product Description" class="form-check-input"> Product Description
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="submit" value="Edit Post" name="submit" class="btn btn-outline-primary" style="margin-left: 45%; margin-top: 2%;">&nbsp;
                            </form>
                        </div> <!-- /.card -->
                        <div style="margin-top: 3%; margin-left: 42%; color: red;">
                                    <?php echo " ". $modal;?>
                                </div>
