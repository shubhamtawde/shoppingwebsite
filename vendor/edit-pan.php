        ...
        <div class="content pb-0">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="box-title">Edit PAN Details </h4>
                        </div>
                        <div class="card-body card-block">
                            <h3 align="center">Enter your new PAN Details:-</h3><br>
                            <form class="form-horizontal" method="POST" action="update-pan.php">
                                <div class="row form-group">
                                    <div class="col col-md-3"><div class="fa fa-tag" style="margin-right: 15px;"></div><label for="hf-product_name" class=" form-control-label">New PAN Number</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="product_name" placeholder="Enter your PAN Number" class="form-control" name="pan_no" required></div>
                                </div>
                                <input type="submit" name="submit" value="Update PAN" style="margin-left: 45%; margin-top: 2%;" class="btn btn-outline-success">
                        </form>
                    </div>
