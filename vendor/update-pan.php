...
$pan=$_POST["pan_no"];
$s="";
$sql="UPDATE vendor_info SET PAN='$pan' WHERE v_id='id1'";
if($conn->query($sql) == TRUE)
{
    $s="Updated PAN Details Successfully!";
}
else
{
    $s="There was an error updating the PAN Details!";
}
?>
    <!-- Left Panel -->
        ...
        <div class="content pb-0">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="box-title">Update PAN Details </h4>
                        </div>
                        <div class="card-body card-block">
                            <h3 align="center"><?php echo $s; ?></h3><br>
                    </div>
