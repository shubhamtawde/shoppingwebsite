        ...
        <div class="content pb-0">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="box-title">View Post </h4>
                        </div>
            ...
            <div class="orders">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title" align="center">Posts</h4>
                            </div>
                            <div class="card-body--">
                                ...
                                <div class="table-stats order-table ov-h">
                                    <table class="table" >
                                        ...
                                        if($n > 0)
                                        {
                                            ...
                                            {
                                                echo "<tr> <td>".$row["id"]."</td> <td>".$row["p_name"]."</td>  <td>" .$row["p_desc"]. "</td> <td>" .$row["p_price"]. "</td> <td>" .$row["add_info"]. "</td> <td>" .$row["stock"]. "</td> <td>" .$row["budget"]. "</td> <td>" .$row["p_color"]. "</td> <td>" .$row["category"]. "</td>";
                                            }
                                        }
                                        ?>
                                    </table>
                                ...
                                <button type="button" class="btn btn-outline-danger" onclick="document.location.href='delete-posts.php';" style="margin-left: 45%;"><i class="fa fa-trash-o"></i>&nbsp; Delete Post</button>
                    </div>  <!-- /.col-lg-8 -->
