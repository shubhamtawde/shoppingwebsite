...
$add=$_POST["p_add"];
$stock=$_POST["p_stock"];
$budget=$_POST["p_budget"];
$color=$_POST["p_color"];
$cat=$_POST["select"];
$sql="INSERT INTO posts_info (v_id,p_name,p_desc,p_price,add_info,stock,budget,p_color,category) VALUES ($id1,'$name', '$desc', $price, '$add', $stock, $budget, '$color', '$cat')";
    //execute query
    if($conn->query($sql) == TRUE)
    {
        $s = "Created Post successfully!";
    }
    else
    {
