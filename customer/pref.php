...
<body class="animsition">
      ...
      <div class="wrap_header_mobile">
         ...
         <div class="btn-show-menu">
            ...
            <div class="header-icons-mobile">
               ...
               <div class="header-wrapicon2">
                  <a href="./cart.php">
                  <img src="images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON"></a>
                  <span class="header-icons-noti">0</span>
   ...
   <!-- Title Page -->
   <section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/pref.jpg);">
   ...
   <div class="container">
      ...
      <div class="container-table-cart pos-relative">
            ...
            <hr>
            <h4
            align="center">Welcome to Fashe! Set your preferences to continue!</h4>
            <form action="set_pref.php">
               <div align="center">
                  <input type="checkbox" name="checkbox1" value="Accessories" style="margin: 30px 30px 30px 30px;">Accessories
                  <input type="checkbox" name="checkbox2" value="Handmade Products" style="margin: 30px 30px 30px 30px;">Handmade Products
                  <input type="checkbox" name="checkbox3" value="Footwear" style="margin: 30px 30px 30px 30px;">Footwear
                  <input type="checkbox" name="checkbox4" value="Menswear" style="margin: 30px 30px 30px 30px;">Menswear
                  <input type="checkbox" name="checkbox5" value="Womenswear" style="margin: 30px 30px 30px 30px;">Womenswear
               </div>
               <center>
               <input class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" type="submit" name="submit" value="Submit" style="width: 50%;">
            </center>
            </form>
            <br>
            <div align="center">
               <i>Already set preferences? <a href="./login.php">Login</a></i>
            </div>
