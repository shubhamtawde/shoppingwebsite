...
$id1=$_COOKIE["id"];
$prod="SELECT * FROM user_info WHERE c_id='$id1'";
...
?>
   ...
   <!-- Title Page -->
   <section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/banner-stripes-account.jpg);">
...
<section class="cart bgwhite p-t-70 p-b-100">
   <div class="container">
      ...
      <div class="container-table-cart pos-relative">
            ...
            <hr>
            <h4
            align="center">Welcome <?php echo $fname . " " . $lname;?>!</h4><br>
            <button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" onclick="location.href='./orders.php'" style="width: 33%; display: inline-block;" >
               View Orders
               </button>
               <button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" onclick="location.href='./update.php'" style="width: 33%; display: inline-block;">
               Update Password
               </button>
               <button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" onclick="location.href='./logout.php'" style="width: 33%; display: inline-block;">
               Logout
               </button>
         </div>
   </div>
