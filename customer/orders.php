...
<?php
$id=$_COOKIE["id"];
$prod="SELECT * FROM order_info WHERE c_id='$id'";
...
?>
   ...
   <!-- Title Page -->
   <section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/orders.jpg);">
            ...
            <div class="wrap-table-shopping-cart bgwhite">
               <table class="table-shopping-cart">
                  <tr class="table-head">
                     ...
                     <th class="column-4 p-l-70">Status</th>
                  ...
                  if($n>0)
                  {
                     while($row = mysqli_fetch_assoc($exec))
                     {
                        ...
                        echo "<td class='column-2'>" . $row["p_name"] . "</td> <td class='column-3'>₹ " . $row["p_price"] . "</td> <td class='column-4' align='center'> <p style='margin-right: 30%;''>" . $row["status"] . "</p> </td> <td class='column-5'>₹ " . $row["p_price"] . "</td> </tr>";
                     }
                  }?>
               </table>
            </div>
