...
?>
   ...
   <!-- Title Page -->
   <section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/prod.jpg);">
               ...
               <div class="row">
                  ...
                  foreach ($sel as $value) {
                     ...
                     while($row = mysqli_fetch_assoc($exec))
                     {
                        ...
                        $prod_url="product-detail.php?id=" . $row["id"];
                     echo "<div class='col-sm-12 col-md-6 col-lg-4 p-b-50'> <div class='block2'> <div class='block2-img wrap-pic-w of-hidden pos-relative block2-labelnew'> <img src='$img' alt='IMG-PRODUCT'>";
                     ...
                     echo "<div class='block2-txt p-t-20'> <a href='$prod_url' class='block2-name dis-block s-text3 p-b-5'>" . $row["p_name"] . "</a> <span class='block2-price m-text6 p-r-5'> ₹" . $row["p_price"] . "</span> </div> </div> </div>";
                     }
                  }
               }
                  ?>
...
<span class="s-text8 p-t-5 p-b-5">
                     Showing 1–12 of <?php echo $no_p; ?> results
                  </span>
               <!-- Pagination -->
