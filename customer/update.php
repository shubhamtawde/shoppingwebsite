...
<section class="cart bgwhite p-t-70 p-b-100">
   <div class="container">
      ...
      <div class="container-table-cart pos-relative">
            ...
            <hr>
            <h4
            align="center">Enter your current and new password below:-</h4><br>
            <form action="update-success.php" method="POST">
               <div style="padding: 30px 30px 30px 30px;">
                  <label>Current Password:-</label>
                  <input type="password" name="current" class="s-text7 bg6 w-full p-b-5" required>
                  <label>New Password:-</label>
                  <input type="password" name="new" class="s-text7 bg6 w-full p-b-5" required>
                  <label>Confirm New Password:-</label>
                  <input type="password" name="conf_new" class="s-text7 bg6 w-full p-b-5" required>
               </div>
               <div align="center">
                  <button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" style="width: 50%; height: 100%;">
                           Update Password
                        </button>
               </div>
